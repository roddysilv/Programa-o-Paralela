...
int main(int argc, char *argv[])
{
    ...
    int totalFases = 0;   //FASES QUE O ALGORITMO MODIFICADO USA
    int totalN = 100 * n; //FASES QUE O ALGORITMO NÃO MODIFICADO USA
    for (int i = 0; i < 100; i++)
    {
        Generate_list(a, n);
        totalFases += Odd_even_sort(a, n);
        //oddEvenModificado(a, n);
    }

    Print_list(a, n, "After sort");

    printf("Total: %d Fases: %d\n\n", totalN, totalFases);
